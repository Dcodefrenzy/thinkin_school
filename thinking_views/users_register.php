...
if(array_key_exists('submit', $_POST)){
  ...
  if(empty($_POST['email'])){
    ...
    $error['username']="Enter a User Name";
  }
...
<div class="form-group">
  <?php $display = displayErrors($error, 'username');
  echo $display ?>
<div class="input-icon">
<i class="icon fa fa-envelope"></i>
<input type="text" id="sender-email" class="form-control" name="username" placeholder="User Name">
</div>
</div>

...
$edit_info = getEditInfo($conn,$_GET['id'],'events');
...
echo $display ?> <input class="form-control input-md" name="event_name" value=<?php echo $edit_info['event_name']; ?> placeholder="Write a Event name"  type="text">
</div>
<div class="form-group mb30">
...
echo $display ?> <input class="form-control input-md" name="time" placeholder="format: 10am-3pm" value=<?php echo $edit_info['event_time']; ?>  type="text">
</div>

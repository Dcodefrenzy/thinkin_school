...
$edit_info = getEditInfo($conn,$_GET['id'],'training');
...
if(array_key_exists('submit', $_POST)){
  ...
  if(empty($_POST['name'])){
    $error['name']="Enter a Training Name";
  }
...
/*    $uri = explode("/", $_SERVER['REQUEST_URI']);
    ...
    editTraining($conn,$clean,$_GET['id']);
  }
}
 ?>
<section id="content">
...
echo $display ?> <input class="form-control input-md" name="name" value=<?php echo $edit_info['name']; ?> placeholder="Write a Event name"  type="text">
</div>
<div class="form-group mb30">
<label class="control-label">Price</label><?php $display = displayErrors($error, 'price');
echo $display ?> <input class="form-control input-md" name="price" value="<?php echo $edit_info['price']; ?>" placeholder="Enter News price here"  type="number">
</div>
<div class="form-group mb30">
<label class="control-label">venue</label><?php $display = displayErrors($error, 'venue');
echo $display ?> <input class="form-control input-md" name="venue" placeholder="Enter venue here" value= "<?php echo $edit_info["venue"]; ?>"  type="text">
</div>
<div class="form-group mb30">
<label class="control-label">Start Date</label><?php $display = displayErrors($error, 'start_date');
echo $display ?> <input class="form-control input-md" name="start_date" value=" <?php echo $edit_info['start_date']; ?>"  placeholder="format: December/10/2018"  type="text">
</div>
<div class="form-group mb30">
<label class="control-label">End Date</label><?php $display = displayErrors($error, 'end_date');
echo $display ?> <input class="form-control input-md" name="end_date" value=" <?php echo $edit_info["end_date"]; ?>" placeholder="format: December/10/2018"  type="text">
</div>
<div class="form-group mb30">
<label class="control-label">Time</label><?php $display = displayErrors($error, 'time');
echo $display ?> <input class="form-control input-md" name="time" placeholder="format: 10am-3pm" value=<?php echo $edit_info['training_time']; ?>  type="text">
</div>

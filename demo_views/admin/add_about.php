...
if(array_key_exists('submit', $_POST)){
  ...
  if(empty($_POST['body'])){
    ...
    $error['mission_statement']="Enter your mission statement";
  }
...
/*    $firstn = $fname;
    ...
    addAbout($conn, $clean,$ver,$hash_id);
  }
}
?>
<section id="content">
        ...
        <div class="page-ads box">
          ...
          <form class="form-ad" action="" method="post" enctype="multipart/form-data">
            <div class="form-group mb30">
                ...
                echo $display ?>
                <textarea class="form-control"  id="editor2" name="mission_statement" placeholder="Write your Mission Statement Here"  rows="4"></textarea>
              </div>
              <br/>
              <br/>

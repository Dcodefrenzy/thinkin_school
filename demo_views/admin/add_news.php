...
if(array_key_exists('submit', $_POST)){
  ...
  if(empty($_POST['category_id'])){
    $error['category_id']="Enter a category_id";
  }
  if(empty($error)){
...
echo $display ?> <input class="form-control input-md" name="author" placeholder="Enter News Author here"  type="text">
</div>
<div class="col-md-4 col-sm-4 col-xs-12 search-bar search-bar-nostyle">
<div class="input-group-addon search-category-container">
<label class="control-labell">News Category </label>  <?php $display = displayErrors($error, 'category_id');
echo $display ?><br><select class="dropdown-product selectpicker" name="category_id" required>
<option value="">
--Select--
</option>

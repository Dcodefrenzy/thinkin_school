...
/*    $uri = explode("/", $_SERVER['REQUEST_URI']);
    ...
    editFrontage($conn, $clean,$hash_id,$_GET['id']);
  }
}
?>
<section id="content">
      ...
      <div class="col-sm-12 col-md-10 col-md-offset-1">
        <div class="page-ads box">
          ...
          <form class="form-ad" action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" id="sender-email" class="form-control" value="<?php echo $edit_info['title'] ; ?>" name="title" placeholder="Captivating Title">
            </div>
            </div>

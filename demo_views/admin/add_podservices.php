...
if(array_key_exists('submit', $_POST)){
  ...
  if(empty($error)){
    ...
    addPodcastSubscription($conn,$clean,$ver,$hash_id);
  }
}
 ?>
...
<h2 class="title-2">Welcome to the Podcast Subscription Page</h2>
<div class="row search-bar mb30 ">
<div class="advanced-search">
<form class="search-form" method="get">
<div class="col-md-4 col-sm-12 search-col">
<h3>Please add subscription details. </h3>
</div>
</form>
</div>
</div>
...
<label class="control-label">Sunsctiption Title</label><br/><?php $display = displayErrors($error, 'subscription');
echo $display ?> <input class="form-control input-md" name="subscription" placeholder="Enter subscription Title"  type="text">
</div>
<div class="form-group mb30">
<label class="control-label">price</label><br/><?php $display = displayErrors($error, 'price');
echo $display ?> <input class="form-control input-md" name="price" placeholder="Enter the subscription price"  type="number">
</div>
   ...
   echo $display ?>
   <textarea class="form-control"  id="editor2" name="body" placeholder="Details about this subscription method."  rows="4"></textarea>
 </div>
 <br/>
 <br/>


<h2 class="title-2">Add an Image</h2>

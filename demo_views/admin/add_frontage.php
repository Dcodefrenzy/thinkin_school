    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-10 col-md-offset-1">
        <div class="page-ads box">
          <h2 class="title-2">Welcome Add Frontage PAge</h2>
          <div class="row search-bar mb30 red-bg">
            <div class="advanced-search">
              <form class="search-form" method="get">
                <div class="col-md-4 col-sm-12 search-col">
                  <h3>Please Content to your front page.</h3>
                </div>
              </form>
            </div>
          </div>
          <form class="form-ad" action="" method="post" enctype="multipart/form-data">
            ...
            <i class="icon fa fa-user"></i><?php $display = displayErrors($error, 'title'); ?>
            <input type="text" id="sender-email" class="form-control" name="title" placeholder="Captivating Title">
            </div>
            </div>
